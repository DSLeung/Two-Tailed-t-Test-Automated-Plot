...
par(mfrow=c(2,1))                                         ## Define 2 Column, 1 Row Array for display of two charts
...
boxplot(y,z,ylab="Title", horizontal = TRUE,border = colors, names=c("First Sample","second Sample"))	      ## Boxplot function
